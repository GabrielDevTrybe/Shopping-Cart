...
describe('2 - Teste a função fetchItem', () => {
  ...
  it('Teste se, ao chamar a função fetchItem com o argumento "MLB1615760527", a função fetch utiliza o endpoint "https://api.mercadolibre.com/sites/MLB/search?q=MLB1615760527"', async () => {
    await fetchItem('MLB1615760527');
  ...
  it('Teste se o retorno da função fetchItem com o argumento do item "MLB1615760527" é uma estrutura de dados igual ao objeto item que já está importado no arquivo.', async () => {
    await fetchItem('MLB1615760527')
    expect(fetch).toHaveReturned(item)
  })
